...
\declaretheoremstyle[name=Postulate,]{prosty}
\declaretheorem[style=prosty,numberwithin=section]{postulate}
\tcolorboxenvironment{postulate}{colback=LightOrange}

\declaretheoremstyle[name=Definition,]{prcpsty}
\declaretheorem[style=prcpsty,numberwithin=section]{definition}
