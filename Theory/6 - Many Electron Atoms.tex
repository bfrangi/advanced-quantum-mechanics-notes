...
\begin{postulate} \label{symmetrisation}
    ...
    \begin{itemize}
        \item In nature, the states of systems containing $N$ identical particles are either totally symmetric or totally antisymmetric under the interchange of any pair of particles. States with mixed symmetry do not exist | they are not physical kets. % CHECK: add intuition behind this regarding $|\psi (a, b)|^2 = |\psi(b, a)|^2\to \psi (a, b) = \pm\psi(b, a)$
...
This determinant is called the \textbf{Slater determinant}. It is now even clearer to see that, if any two states or more are equal, we will have as many equal columns as equal states. This will immediately make the determinant go to zero.
